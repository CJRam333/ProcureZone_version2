            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <s:form action="issueNoteRequestStoresList1.action" id="issueNoteStatus" method="post"> 
                            <s:hidden id="note_Id" name="noteId" />
                        </s:form>
                        <s:form action="getStoresIssueNoteDetails.action" id="approveIssueNote" method="post"> 
                            <s:hidden id="note_Id1" name="noteId" />
                        </s:form>
                        <s:form action="issueNoteDetailsStoresView.action" id="finalApproveIssueNote" method="post"> 
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <s:iterator value="listTblIssueNote">
                                        <s:if test="tblIndentStatusByIssueNoteApprovedStatus.indentStatusId==3 && tblIndentStatusByIssueNoteStoresbyStatus.indentStatusId==11">
                                            <tr>
                                        ...
                                        <s:elseif test="tblIndentStatusByIssueNoteApprovedStatus.indentStatusId==3 && tblIndentStatusByIssueNoteStoresbyStatus.indentStatusId==1">
                                            <tr>
                                        ...
                                        <s:elseif test="tblIndentStatusByIssueNoteApprovedStatus.indentStatusId==2 && tblIndentStatusByIssueNoteStoresbyStatus.indentStatusId==1">
                                            <tr>
                                                <td><s:a href="javascript:void(0)" onclick="getSubmit2(%{issueNoteId})" ><s:property value="issueNoteNo"/></s:a></td>
                                                <td><s:a href="javascript:void(0)" onclick="getSubmit2(%{issueNoteId})" ><s:property value="tblEmpMasterByIssueNoteCreatedby.empName"/></s:a></td>
                                                <td><s:a href="javascript:void(0)" onclick="getSubmit2(%{issueNoteId})" ><s:property value="tblCompanyMaster.compName"/></s:a></td>
