                                ...
                                <div class="box-body">
                                                ...
                                                <s:iterator value="listTblIssueNoteDetails">
                                                    <tr>                                                    
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input onblur="getBalQty();" id="reqqty[]" name="reqqty" type="text" value="<s:property value="issueNoteDetailsRequestedQuantity"/>" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-9">
                                                <s:select onchange="getBalQty1();" name="indentStatusId" list="listTblIndentStatus" headerKey="0" headerValue="--- Select ---" listKey="indentStatusId" listValue="indentStatusName" cssClass="form-control select2"/>
                                            </div>
                                        </div>
                                    </div>        
