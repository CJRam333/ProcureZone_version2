                                        ...
                                        <tbody>
                                            <s:iterator value="listTblIndentDetails">
                                                <tr>
                                                    ...
                                                    <%--<td><s:a href="javascript:void(0)" cssClass="btn btn-default" onclick="getSubmit(%{indentId})" > <span class="fa fa-edit"></span></s:a></td>                                                  
                                                    <td><s:a href="javascript:void(0)" cssClass="btn btn-default" onclick="getSubmit1(%{indentId})"> <span class="fa fa-trash"></span></s:a></td>--%>
                                                </tr>
                                            </s:iterator>
                                        </tbody>
                                    </table>
