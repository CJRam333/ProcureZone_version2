...
<html>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="saveFinalIndentRequest.action" method="post" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <s:iterator value="listTblIndentDetails">
                                                <tr>
                                                    <%--<td><input id="detailsCount[]" name="detailsCount" value="<s:property value="indentDetailsId"/>" class="col-md-13" readonly style=" border: none;background: transparent;"></td>--%>
                                                    ...
                                                    <td><s:if test="%{indentDetailsRmQty!=null}">
                                                            <s:property value="indentDetailsRmQty"/>
                                                        </s:if>
                                                        <s:else>
                                                            <s:property value="indentDetailsQty"/>
                                                        </s:else>
                                                    </td>
                                                    <td>                                                        
                                                        <div class="col-xs-7">
                                                            <s:if test="%{indentDetailsRmQty!=null}">
                                                                <input id="deptQty[]" name="deptQty" type="text" value="<s:property value="indentDetailsRmQty"/>" class="form-control">
                                                            </s:if>
                                                            <s:else>
                                                                <input id="deptQty[]" name="deptQty" type="text" value="<s:property value="indentDetailsQty"/>" class="form-control">
                                                            </s:else>
                                                        </div>
                                                    </td>
                                                    <td>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textarea name="finalRemarks"  cssClass="form-control"/>
                                        </div>
                                    </div>
                                </div>        
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:select name="indentStatusId" list="listTblIndentStatus1" headerKey="0" headerValue="--- Select ---" listKey="indentStatusId" listValue="indentStatusName" cssClass="form-control select2"/>
                                        </div>
                                    </div>
                                </div>        
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary">Submit</button>
                                    <a href="<s:url action="deptHeadIndentRequestList.action"/>"> <span class="btn btn-danger pull-right">Back to List</span></a>
                                </div>
                            </div>
                            <!-- /.box-body -->
                        </form>
    ...
    <script>
        function CheckQty() {
            var q = document.getElementsByName("deptQty");
            var s = document.getElementsByName("stock");
            for (var i = 0; i < q.length; i++) {
                if (parseFloat(s[i].value, 10) > parseFloat(q[i].value)) {
