                            ...
                            <div class="box-body"> 
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:select disabled="true" name="indentStatusId" list="listTblIndentStatus" headerKey="0" headerValue="--- Select ---" listKey="indentStatusId" listValue="indentStatusName" cssClass="form-control select2"/>
                                        </div>
                                    </div>
                                </div>      
