...
<html>
                            ...
                            <div class="box-body"> 
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>  
                                                ...
                                                <th id="status<s:property value="%{#sno}"/>">Pricing</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <s:iterator value="listTblIndentDetails">
                                                <tr>                                                    
                                                    ...
                                                    <td id="status<s:property value="%{#sno}"/>"><s:property value="indentDetailsPricing"/></td>
                                                </tr>
                                ...
                                <%--<div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textarea name="procurementRemarks" readonly="true" cssClass="form-control"/>                                            
                                        </div>
                                    </div>
                                </div>--%>                                
                                <div class="row" id="status">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textfield name="deliveryDate" readonly="true" cssClass="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" id="status1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textfield name="poNumber" readonly="true" cssClass="form-control"/>
                                        </div>
                                    </div>
                                </div> 
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:select  id="indentStatusId" disabled="true" name="indentStatusId" list="listTblIndentStatus3" headerKey="0" headerValue="--- Select ---" listKey="indentStatusId" listValue="indentStatusName" cssClass="form-control select2"/>
                                        </div>
                                    </div>
                                </div>      
    ...
    <script>
        $(function () {
            ...
            var b = parseInt(<s:property value="indentStatusId"/>);              
            var i = a - 1;
            var j;
            if (b == 7 || b == 9) {
                $('#status').show()
