...
<html>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="saveProcurementIndentRequest.action" method="post" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Dept. Head Quantity Requested</th>
                                                <th >Available Stock</th>
                                                <th id="status2">Pricing</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <s:set id="sno" name="sno" value="4"/>
                                            <s:iterator value="listTblIndentDetails">
                                                <tr>
                                                    ...
                                                    <td><s:property value="indentDetailsRmQty"/></td>
                                                    <td><s:property value="indentDetailsDeptQty"/></td>
                                                    <td><s:property value="indentDetailsStockAval"/></td>
                                                    <td id="status<s:property value="%{#sno}"/>">
                                                        <div class="col-xs-7">
                                                            <input id="pricing<s:property value="%{#sno}"/>" name="pricing" type="text" value="0.00" class="form-control">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <s:set id="sno" name="sno" value="%{#sno+1}"/>
                                            </s:iterator>
                                        </tbody>
                                    </table>
                                </div>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Final Remarks</label> 
                                        <div class="col-xs-9">
                                            <s:textarea name="finalRemarks" readonly="true" cssClass="form-control"/>
                                        </div>
                                    </div>
                                </div>  
                                <div class="row">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Procurement Remarks</label> 
                                        <div class="col-xs-9">
                                            <s:textarea name="procurementRemarks" cssClass="form-control"/>                                            
                                        </div>
                                    </div>
                                </div>                                
                                <div class="row" id="status">
                                    <div class="form-group">
                                        ...
                                        <div class="date col-sm-9">
                                            <s:textfield name="deliveryDate" id="datepicker" cssClass="form-control pull-right"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" id="status1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textfield name="poNumber" cssClass="form-control"/>
                                        </div>
                                    </div>
                                </div>  
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:select  id="indentStatusId" name="indentStatusId" list="listTblIndentStatus3" headerKey="0" headerValue="--- Select ---" listKey="indentStatusId" listValue="indentStatusName" cssClass="form-control select2"/>
                                        </div>
                                    </div>
                                </div>       
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary">Submit</button>
                                    <a href="<s:url action="getProcurementList.action"/>"> <span class="btn btn-danger pull-right">Back to List</span></a>
                                </div>
                            </div>
                            <!-- /.box-body -->
                        </form>
    ...
    <script>
        $('#indentStatusId').on('change', function () {
            var a = parseInt(<s:property value="%{#sno}"/>);
            var i = a - 1;
            var j;
