                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="saveRmIssueNoteRequest.action" method="post" class="form-horizontal">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">                                                                                                       
                                                    <s:textfield name="indentNo" readonly="true" cssClass="form-control"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                        ...
                                                        <td>                                                        
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    ...
                                                                    <input name="md1" readonly type="text" value="<s:property value="%{tblIndentDetails.tblMaterialMaster.materialDesc}"/> - <s:property value="%{tblIndentDetails.tblMaterialMaster.materialName}"/>" class="form-control">                                                                   
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="reqqty" value="<s:property value="goodsReceiptRequestedQuantity"/>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="balqty" value="<s:property value="goodsReceiptBalanceQuantityStores"/>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>                                                    
                                                    </tr>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textarea name="rmremarks" cssClass="form-control"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a href="<s:url action="rmIssueNoteRequestList.action"/>"> <span class="btn btn-danger pull-right">Back to List</span></a>
                                    </div>
                                </div>                                            
                            </form>
                        </div>                                
