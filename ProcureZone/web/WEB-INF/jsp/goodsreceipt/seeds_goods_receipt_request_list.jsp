    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Goods Receipt List</li>
            </ol>
        </section>
        <!-- Main content -->
                    ...
                    <div class="box">
                        ...
                        <script>
                            function getSubmit(val)
                            {
                                ...
                                var frm = document.getElementById("goodsReceiptStatus");
                                frm.submit();
                            }
                            function getSubmit1(val)
                            {
                                document.getElementById("receipt_Id1").value = val;
                                var frm = document.getElementById("goodsReceipt");
                                frm.submit();
                            }
                        ...
                        <s:form action="goodsReceiptRequestList1.action" id="goodsReceiptStatus" method="post"> 
                            <s:hidden id="receipt_Id" name="receiptId" />
                        </s:form>
                        <s:form action="goodsReceiptDetails.action" id="goodsReceipt" method="post"> 
                            <s:hidden id="receipt_Id1" name="receiptId" />
                        </s:form>
                        <s:form action="getGoodsReceiptDetailsView.action" id="approveIssueNote" method="post"> 
                        ...
                        <div class="box-body">
                            <div class="box-footer">
                                ...
                                <a href="<s:url action="addGoodsReceiptRequest.action"/>"> <span class="box-title btn btn-success pull-right">Add Goods Receipt</span></a>
                            </div>
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <s:iterator value="listTblGoodsReceipt">
                                        <s:if test="tblIndentStatusByGoodsReceiptStoresbyStatus.indentStatusId==10">
                                            <tr>
                                                    ...
                                                    <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="goodsReceiptOpeningQuantity"/></s:a></td>
                                                    <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="goodsReceiptQuantity"/></s:a></td>
                                    ...
                                    <%--<s:iterator value="listTblGoodsReceipt">
                                        <s:if test="tblIndentStatusByGoodsReceiptApprovedStatus.indentStatusId==1">
                                            <tr>
                                                ...
                                                <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="tblIndentMaster.tblCompanyMaster.compName"/></s:a></td>
                                                <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="tblIndentDetails.tblMaterialMaster.materialName"/></s:a></td>
                                                <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="tblIndentDetails.indentDetailsStockAval"/></s:a></td>
