                                        ...
                                        <table id="example1" class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <s:iterator value="listTblGoodsReceipt">
                                                    <tr>
                                                        <td><s:property value="tblIndentDetails.tblMaterialMaster.materialName"/></td>
                                                        <td><s:property value="tblIndentDetails.tblMaterialMaster.materialDesc"/></td>
                                                        <td><s:property value="goodsReceiptRequestedQuantity"/></td>
                                                        <td><s:property value="goodsReceiptBalanceQuantityStores"/></td>                                       
                                                    </tr>
                                                </s:iterator>
                                            </tbody>
                                        </table>
