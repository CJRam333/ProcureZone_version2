                    ...
                    <div class="box">
                        ...
                        <script>
                            ...
                            function getSubmit1(val)
                            {
                                ...
                                var frm = document.getElementById("issueNoteDetails");
                                frm.submit();
                            }
                        ...
                        <s:form action="issueNoteRequestList1.action" id="issueNoteStatus" method="post"> 
                            <s:hidden id="receipt_Id" name="receiptId" />
                        </s:form>
                        <s:form action="getIndent.action" id="issueNoteDetails" method="post"> 
                            <s:hidden id="receipt_Id1" name="receiptId" />
                        </s:form>
                        <s:form action="getSelfIssueNoteDetails.action" id="approveIssueNote" method="post"> 
                                ...
                                <tbody>
                                    <s:iterator value="listTblGoodsReceipt">
                                        <tr>
                                            ...
                                            <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="tblIndentMaster.tblEmpMasterByIndentCreatedby.empName"/></s:a></td>
                                            ...
                                            <td><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" ><s:property value="goodsReceiptBalanceInventory"/></s:a></td>
                                            ...
                                            <td><s:if test="%{tblIndentStatusByGoodsReceiptApprovedStatus.indentStatusId==1 && tblIndentStatusByGoodsReceiptStoresbyStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" >Pending</s:a></s:if>
                                                <s:if test="%{tblIndentStatusByGoodsReceiptApprovedStatus.indentStatusId==2 && tblIndentStatusByGoodsReceiptStoresbyStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" >RM Rejected</s:a></s:if>
                                                <s:if test="%{tblIndentStatusByGoodsReceiptApprovedStatus.indentStatusId==3 && tblIndentStatusByGoodsReceiptStoresbyStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" >RM Approved</s:a></s:if>
                                                <s:if test="%{tblIndentStatusByGoodsReceiptStoresbyStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" >Goods Receipt</s:a></s:if>
                                                <s:if test="%{tblIndentStatusByGoodsReceiptApprovedStatus.indentStatusId==3 && tblIndentStatusByGoodsReceiptStoresbyStatus.indentStatusId==11}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{goodsReceiptId})" >Goods Issued</s:a></s:if>
                                                    </td>
                                                </tr>
                                    </s:iterator>
                                </tbody>
