                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            ...
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="saveIssueNoteRequest.action" method="post" class="form-horizontal">
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">                                                                                                       
                                                    <s:select name="indentId" id="indentId" list="listTblIndentMaster" onchange="this.form.action='getIndent.action'; this.form.submit();" headerKey="0" headerValue="--- Select ---" listKey="indentId" listValue="indentNo" cssClass="form-control select2"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <s:iterator value="listTblGoodsReceipt">
                                                    <tr>                                                    
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="reqqty" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="balqty" readonly value="<s:property value="%{goodsReceiptBalanceInventory}"/>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>                                                    
                                                    </tr>
                                                ...
                                                <%--<s:iterator value="listTblIndentDetails">
                                                    <tr>                                                    
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="balqty" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>                                                    
                                                    </tr>
