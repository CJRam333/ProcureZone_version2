                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">                                                                                                       
                                                    <s:select name="indentId" id="indentId" list="listTblIndentMaster" onchange="this.form.action='getIndentDetails.action'; this.form.submit();" headerKey="0" headerValue="--- Select ---" listKey="indentId" listValue="indentPoNumber" cssClass="form-control select2"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
