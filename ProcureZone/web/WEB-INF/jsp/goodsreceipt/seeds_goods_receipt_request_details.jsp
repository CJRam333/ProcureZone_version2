                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">                                                                                                       
                                                    <s:select disabled="true" name="indentId" id="indentId" list="listTblIndentMaster" headerKey="0" headerValue="--- Select ---" listKey="indentId" listValue="indentPoNumber" cssClass="form-control select2"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <s:iterator value="listTblGoodsReceipt">
                                                    <tr>                                                    
                                                        <td>                                                        
                                                            <div class="form-group">
                                                                <div class="col-md-12">                                                                   
                                                                    <input name="md"  type="hidden" value="<s:property value="%{tblIndentDetails.tblMaterialMaster.materialId}"/>" class="form-control">
                                                                    <input name="md1"  readonly type="text" value="<s:property value="%{tblIndentDetails.tblMaterialMaster.materialDesc}"/> - <s:property value="%{tblMaterialMaster.materialName}"/>" class="form-control">                                                                
                                                                </div>
                                                            </div>
                                                        </td>                                                        
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="openqty" readonly  value="<s:property value="goodsReceiptOpeningQuantity"/>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input onblur="getBalInv();" readonly name="goodsreceiptqty" value="<s:property value="goodsReceiptQuantity"/>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <%--<td>
                                                        ...
                                                        <td>
                                                            <div class="form-group">
                                                                <div class="col-md-12">
                                                                    <input name="balinventory" readonly value="<s:property value="goodsReceiptBalanceInventory"/>" type="text" class="form-control">
                                                                </div>
                                                            </div>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-9">
                                                <s:textarea readonly="true" name="storesremarks"  cssClass="form-control"/>
                                            </div>
                                        </div>
                                    </div>
