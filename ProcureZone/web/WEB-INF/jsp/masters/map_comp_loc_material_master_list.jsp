...
<html>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Company Location Material Map Master
                <small></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Masters</a></li>
                <li class="active">Company Location Material Map List</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Company Location Material Map Master List</h3>
                            <s:if test="#session.add=='true'">
                                <a href="<s:url action="addCompLocMaterial.action"/>"> <span class="box-title btn btn-success pull-right">Add Company Location Material Map</span></a>
                            </s:if>
                        </div>
                        ...
                        <script>
                            ...
                            {
                                document.getElementById("complocmaterial_Id").value = val;
                                var frm = document.getElementById("complocmaterialedit");
                                frm.submit();
                            }
                            function getSubmit1(val)
                            {
                                document.getElementById("complocmaterial_Id1").value = val;
                                var frm = document.getElementById("complocmaterialdel");
                                frm.submit();
                            }
                            function getSubmit2(val)
                            {
                                document.getElementById("complocmaterial_Id2").value = val;
                                var frm = document.getElementById("complocmaterialview");
                                frm.submit();
                            }
                        </script>
                        <s:form action="updateCompLocMaterial.action" id="complocmaterialedit" method="post" > 
                            <s:hidden id="complocmaterial_Id" name="compLocMaterialId" />
                        </s:form>  
                        <s:form action="deleteCompLocMaterial.action" id="complocmaterialdel" method="post"> 
                            <s:hidden id="complocmaterial_Id1" name="compLocMaterialId" />
                        </s:form>
                        <s:form action="viewCompLocMaterial.action" id="complocmaterialview" method="post"> 
                            <s:hidden id="complocmaterial_Id2" name="compLocMaterialId" />
                        </s:form>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <s:iterator value="listTblMapCompanyLocationMaterial">
                                        <tr>
