                        ...
                        <form action="#" method="post" class="form-horizontal">
                            <div class="box-body">                                         
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <s:select disabled="true" name="empNumber1" list="listTblEmpMaster1" headerKey="0" headerValue="--- Select ---" listKey="empNumber" listValue="empName" cssClass="form-control select2"/>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Start Date</label>
                                    <div class="date col-sm-10">                                                
                                        <s:textfield readonly="true" name="startDate" cssClass="form-control pull-right" id="datepicker"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">End Date</label>
                                    <div class="col-sm-10">
                                        <s:textfield readonly="true" name="endDate" cssClass="form-control pull-right" id="datepicker1"/>
                                    </div>
                                </div>                                        
                            </div>
                            <!-- /.box-body -->
