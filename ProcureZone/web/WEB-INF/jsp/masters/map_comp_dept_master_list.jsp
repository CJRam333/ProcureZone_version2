<%-- 
    Document   : map_comp_dept_master_list
    Created on : Oct 1, 2019, 11:40:47 AM
    Author     : ramesh.avv
--%>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Company Department Map List</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Company Department Map List</h3>
                            <s:if test="#session.add=='true'">
                                <a href="<s:url action="addCompDept.action"/>"> <span class="box-title btn btn-success pull-right">Add Company Department Map</span></a>
                            </s:if>
                        </div>
                        ...
                        <script>
                            ...
                            {
                                document.getElementById("compdept_Id").value = val;
                                var frm = document.getElementById("compdeptedit");
                                frm.submit();
                            }
                            function getSubmit1(val)
                            {
                                document.getElementById("compdept_Id1").value = val;
                                var frm = document.getElementById("compdeptdel");
                                frm.submit();
                            }
                            function getSubmit2(val)
                            {
                                document.getElementById("compdept_Id2").value = val;
                                var frm = document.getElementById("compdeptview");
                                frm.submit();
                            }
                        </script>
                        <s:form action="updateCompDept.action" id="compdeptedit" method="post" > 
                            <s:hidden id="compdept_Id" name="compDeptId" />
                        </s:form>  
                        <s:form action="deleteCompDept.action" id="compdeptdel" method="post"> 
                            <s:hidden id="compdept_Id1" name="compDeptId" />
                        </s:form>
                        <s:form action="viewCompDept.action" id="compdeptview" method="post"> 
                            <s:hidden id="compdept_Id2" name="compDeptId" />
                        </s:form>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <s:iterator value="listTblMapCompanyDepartment">
                                        <tr>
