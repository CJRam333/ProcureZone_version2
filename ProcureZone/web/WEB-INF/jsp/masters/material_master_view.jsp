                        ...
                        <form action="#" method="post" class="form-horizontal">
                            <div class="box-body">                                         
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <s:textfield name="matCode" readonly="true" cssClass="form-control"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Material Name</label>
                                    <div class="col-sm-10">
                                        <s:textfield name="matName" readonly="true" cssClass="form-control"/>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Material Description</label>
                                    <div class="col-sm-10">
                                        <s:textfield name="matDesc" readonly="true" cssClass="form-control"/>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
