            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="saveMaterial.action" method="post" class="form-horizontal">
                            <div class="box-body">                                         
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Material Code</label>
                                    <div class="col-sm-10">
                                        <s:textfield name="matCode" cssClass="form-control"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <s:textfield name="matName" cssClass="form-control"/>
                                    </div>
                                </div> 
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Material Description</label>
                                    <div class="col-sm-10">
                                        <s:textfield name="matDesc" cssClass="form-control"/>
                                    </div>
                                </div>    
                            </div>
                            <!-- /.box-body -->
