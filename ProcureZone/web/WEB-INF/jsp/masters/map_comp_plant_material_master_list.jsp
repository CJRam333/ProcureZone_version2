    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Company Plant Material Map List</li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Company Plant Material Map Master List</h3>
                            <s:if test="#session.add=='true'">
                                <a href="<s:url action="addCompPlantMaterial.action"/>"> <span class="box-title btn btn-success pull-right">Add Company Plant Material Map</span></a>
                            </s:if>
                        </div>
                        ...
                        <script>
                            ...
                            {
                                document.getElementById("compplantmaterial_Id").value = val;
                                var frm = document.getElementById("compplantmaterialedit");
                                frm.submit();
                            }
                            function getSubmit1(val)
                            {
                                document.getElementById("compplantmaterial_Id1").value = val;
                                var frm = document.getElementById("compplantmaterialdel");
                                frm.submit();
                            }
                            function getSubmit2(val)
                            {
                                document.getElementById("compplantmaterial_Id2").value = val;
                                var frm = document.getElementById("compplantmaterialview");
                                frm.submit();
                            }
                        </script>
                        <s:form action="updateCompPlantMaterial.action" id="compplantmaterialedit" method="post" > 
                            <s:hidden id="compplantmaterial_Id" name="compPlantMaterialId" />
                        </s:form>  
                        <s:form action="deleteCompPlantMaterial.action" id="compplantmaterialdel" method="post"> 
                            <s:hidden id="compplantmaterial_Id1" name="compPlantMaterialId" />
                        </s:form>
                        <s:form action="viewCompPlantMaterial.action" id="compplantmaterialview" method="post"> 
                            <s:hidden id="compplantmaterial_Id2" name="compPlantMaterialId" />
                        </s:form>
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <s:iterator value="listTblMapCompanyPlantMaterial">
                                        <tr>
                                            <td><s:property value="tblCompanyMaster.compName"/></td>
                                            <td><s:property value="tblPlantMaster.plantName"/></td>
                                            <td><s:property value="tblMaterialMaster.materialName"/></td>
                                            <td><s:property value="mapQuantityStores"/></td>
