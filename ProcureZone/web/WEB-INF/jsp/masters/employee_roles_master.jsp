                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form action="saveEmpRoles.action" method="post" class="form-horizontal">
                                    <div class="box-body">                                         
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <s:select name="roleId" list="listTblRolesMaster" headerKey="0" headerValue="--- Select ---" listKey="roleId" listValue="roleName" cssClass="form-control select2"/>
                                            </div>
                                        </div>                                                                                
                                    </div>
                                    <!-- /.box-body -->
