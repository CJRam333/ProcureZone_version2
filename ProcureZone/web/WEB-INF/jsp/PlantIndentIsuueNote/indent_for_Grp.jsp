...
<html>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Indent for GRP Receipt
                <small></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Plant Indent</a></li>
                <li class="active">Indent for GRP Receipt</li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="savePzGrnRequest.action" method="post" name="myForm" onsubmit="return validateForm()" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
...
<!--                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                <s:textfield name="stoLocationa" readonly="true" cssClass="form-control"/> 
                                            </div>
...
<!--                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <span class="field">
                                                        <s:textfield name="grnreceiptnumber"  cssClass="form-control" />                        
                                                    </span>	
...
<!--                                <div class="row" style="padding-left:20px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">GRN Receipt Comments</label> 
                                        <div class="col-xs-9">
                                            <s:textarea name="indentGrnReceiptComments"  cssClass="form-control"/>
                                        </div>
...
function validateForm() {
  let x = document.forms["myForm"]["grnreceiptnumber"].value;
  let y = document.forms["myForm"]["indentGrnReceiptComments"].value;
  
  if (x == "") {
    alert("Good Receipt Number must be filled out.");
    return false;
  }else if (y == "") {
