            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <s:form action="getSelfIndentDetailsPz.action" id="approveInd" method="post"> 
...
<!--                                <div class="col-xs-2">
                                ...
                                <!--<a href="<s:url action="addfloorMgrIndentRequest.action"/>"> <span class="box-title btn btn-success pull-right">Check Indents</span></a>-->
                            </div>
					...
					<th>Plant Id</th>
					    ...
					    <td><s:property value="tblPlantMaster.plantId"/></td>                                            
                                            ...
                                            <td><s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==2 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{indentId})" >Inventory Issue Pending</s:a></s:if>
