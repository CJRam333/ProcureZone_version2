...
<html>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Indent for Floor-Incharge 
                <small></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Plant Indent</a></li>
                <li class="active">Indent for Inventory Receipt</li>
            </ol>
        </section>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Indent for Inventory Receipt</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="saveFlInchargeIndentPzRequest.action" method="post" name="myForm" onsubmit="return validateForm()" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
...
<!--                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-xs-6">
                                                    <span class="field">
                                                        <s:textfield name="atualOutputQty" id ="atualOutputQtya" onchange="chackactualQty()" cssClass="form-control" />                        
                                                    </span>	
                                                ...
                                                <label class="col-md-3 control-label">Storage Location</label>
                                                <div class="col-xs-6">
                                                    <span class="field">
                                                        <s:select name="stoLocationa" id="stoLocationa" list="listTblPzStoLoc" headerKey="0" headerValue="--- Select ---" listKey="stoLoc+' - '+ stoLocDesc" listValue="stoLoc +' - '+ stoLocDesc" cssClass="form-control select2"/>
                                                    </span>	
...
<!--                                <div class="row" style="padding-left:20px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">Floor-Incharge Comments/Remarks</label> 
                                        <div class="col-xs-9">
                                            <s:textarea name="indentFlinchargeComments"  cssClass="form-control"/>
                                        </div>
...
<!--                                    <div class="form-group">
                                        <s:iterator value="listTblpzIndentMastera">
                                        
                                        <label class="col-sm-2 control-label">Status</label> 
                                        <div class="col-xs-9">
                                            <s:select name="indentStatus"  id="indentstratusa" list="listTblIndentStatus"  headerKey="0" headerValue="--- Select ---" listKey="indentStatusId" listValue="indentStatusName" cssClass="form-control select2"/>
                                        </div>
                                        </s:iterator>
...
<!--                                    <a href="<s:url action="indentRequestList.action"/>"> <span class="btn btn-danger pull-right">Back to List</span></a>-->
    ...
    <script>
        ...
        <script>
            ...
            function chackactualQty(){
                
                var q =  document.getElementsByName("atualOutputQty");
                var s = document.getElementsByName("expoutPut");
                for (var i = 0; i < q.length; i++) {
                    //alert(s[i].value);
                    if (parseFloat(s[i].value, 10) < parseFloat(q[i].value, 10)) {
                        
                        alert("Actual Output Qty is Higher than Expected Output Qty.");
                        //q[i].value = "";
...
function validateForm() {
  let x = document.forms["myForm"]["atualOutputQty"].value;
  let y = document.forms["myForm"]["indentFlinchargeComments"].value;
//  //let z = document.forms["myForm"]["stoLocationa"].value;
//  
//  var x1 = document.getElementById("stoLocationa").selectedIndex;
//  var y1 = document.getElementById("stoLocationa").options;
//  alert("Index: " + y1[x1].index + " is " + y1[x1].text);


var e = document.getElementById("stoLocationa");
var strUser = e.options[e.selectedIndex].value;
  
  if (x == "") {
    alert("Atual Output Quantity must be filled out.");
    return false;
  }else if (y == "") {
