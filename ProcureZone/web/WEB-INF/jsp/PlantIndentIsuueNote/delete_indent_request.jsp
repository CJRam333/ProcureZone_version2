            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="deletePlantIndent.action" method="post" name="myForm" onsubmit="return validateForm()" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
...
<!--                                <div class="row" style="padding-left:20px">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textarea name="Rejectcomments"  cssClass="form-control"/>
                                        </div>
                                ...
                                <div class="box-footer" style="padding-left:20px">
                                    <button id= "sbtbtn" type="submit" onclick="confirmDelete(); return false;" class="btn btn-danger " >Delete Indent</button>
