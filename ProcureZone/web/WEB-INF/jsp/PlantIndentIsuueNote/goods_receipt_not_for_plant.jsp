    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Indent For DEO</li>
            </ol>
        </section>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="saveDeoIndentPzRequest.action" method="post" name="myForm" onsubmit="return validateForm()" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
...
<!--                                            <div class="form-group">
                                ...
                                <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <s:iterator value="listTblPzIndentDetails">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--<td><input type="button" value="Quality Check" onclick="OpenLoginPopup()"/></td>-->
                                                    </tr>
                                    ...
                                    <label>
                                        STL : </label><s:property value="indentLoteNum"/><br />
                                    <label>
                                        ODV : </label><s:property value="indentMateDesc"/><br />
                                        <label>
                                        GOT : </label><s:property value="indentStoLoc"/><br />
                                        <label>
                                        ELISA : </label><s:property value="indentDetailsVendor"/><br />
...
<!--                                <div class="row" style="padding-left:20px">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">Quality  Manager Comments/Remarks</label> 
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="col-sm-2 control-label">DEO Comments/Remarks</label> 
                                        <div class="col-xs-9">
                                            <s:textarea name="indentDeoComments"  cssClass="form-control"/>
                                        </div>
...
<script type="text/javascript">
        function OpenLoginPopup() {
            ...
            var popupSetting = { width: '500', height: '500', title: 'QUALITY RESULTS',isFixed:true };
