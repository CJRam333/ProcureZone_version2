...
<!--                                <div class="col-xs-2">
                                ...
                                <a href="<s:url action="addPlantIndentRequest.action"/>"> <span class="box-title btn btn-success pull-right">Add Indent</span></a>
                            </div>
...
<!--                                        <th>Action</th>-->
					    ...
					    <td><s:property value="tblPlantMaster.plantId"/></td>
                                            ...
                                            <td><s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==2 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Inventory Issue Pending</s:if>
                                                ...
                                                <%--<s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==13 && tblIndentStatusByIndentFinalStatus.indentStatusId==13 && tblIndentStatusByIndentProcurementStatus.indentStatusId==1}">Rejected</s:if>--%>
                                                
                                                    </td>
<!--                                                    <td><s:a href="javascript:void(0)" onclick="getSubmit2(%{indentNo})" ><span class="box-title btn btn-danger pull-right">Delete Indent</span></s:a></td>  -->
                                                </tr>
                                    </s:iterator>
                                </tbody>
                            </table>  
