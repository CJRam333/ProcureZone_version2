...
<html>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                Indent issue Confirmation
                <small></small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                <li><a href="#">Masters</a></li>
                <li class="active">Indent issue Confirmation List </li>
            </ol>
        </section>
        <!-- Main content -->
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Indent issue Confirmation </h3>
                        </div>
                        ...
                        <s:form action="getIssueConfirmation.action" id="approveInd" method="post"> 
					...
					<th>Plant Id</th>
					    ...
					    <td><s:property value="tblPlantMaster.plantId"/></td>  
                                            ...
                                            <td><s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==2 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Inventory Issue Pending</s:if>
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==3 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{indentId})" >Inventory issue Confirmation   </s:a></s:if>
