            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="savefmIndentPzRequest.action" method="post" name="myForm" onsubmit="return validateForm()" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
                                                ...
                                                <s:iterator value="listTblPzIndentDetails">
                                                    <tr>                                                    
                                                        ...
                                                        <td><input  id="recstock[]" value="<s:property value="indentDetailsStockAval"/>" name="stock" type="text" readonly="readonly" class="form-control" style="width: 90px;"></td>
                                                         <td><input  id="recqty[]" value="<s:property value="indentDetailsQty"/>"  onchange="CheckQty();" name="qty" type="text" class="form-control" style="width: 90px;"></td>
...
<!--                                <div class="row" style="padding-left:20px">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-9">
                                            <s:textarea readonly="true" name="indentDeoComments"  cssClass="form-control"/>
                                        </div>
