                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Indent For GRP Receipt </h3>
                        </div>
                        ...
                        <s:form action="getGRNReceipt.action" id="approveInd" method="post"> 
...
<!--                                <a href="<s:url action="addFloorInchargeforplant.action"/>"> <span class="box-title btn btn-success pull-right">Check Indents</span></a>-->
					...
					<th>Plant Id</th>
					    ...
					    <td><s:property value="tblPlantMaster.plantId"/></td>  
                                            ...
                                            <td><s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==1 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Inventory Issue Pending</s:if>
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==2 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Inventory issue Confirmation</s:if>
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==3 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Deo Order Pending</s:if>
                                                ...
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==5 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{indentId})" >GRN Receipt pending</s:a></s:if>
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==6 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Receipt Confirmation pending</s:if>   
