            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="box">
                        ...
                        <s:form action="getSelfIndentDetailsFlIncharge.action" id="approveInd" method="post"> 
...
<!--                                <div class="col-xs-2">
					...
					<th>Plant Id</th>
					    ...
					    <td><s:property value="tblPlantMaster.plantId"/></td>   
                                            ...
                                            <td><s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==3 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Inventory Issue Pending</s:if>
                                                ...
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==4 && tblIndentStatusByIndentFinalStatus.indentStatusId==1&& tblIndentStatusByIndentProcurementStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{indentId})" >Inventory Receipt Pending</s:a></s:if>
