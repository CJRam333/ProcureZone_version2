            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form action="savePzReceiptConfirmation.action" method="post" name="myForm" onsubmit="return validateForm()" class="form-horizontal">
                            <div class="box-body"> 
                                <div class="row">
                                    <div class="col-md-6">
...
<!--                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="col-md-3 control-label">Actual OutPut Quantity</label>
                                                <div class="col-xs-6">
                                                    <span class="field">
                                                        <s:textfield name="atualOutputQty" readonly ="true" cssClass="form-control pull-right"  id="datepicker"/>                        
                                                    </span>	
