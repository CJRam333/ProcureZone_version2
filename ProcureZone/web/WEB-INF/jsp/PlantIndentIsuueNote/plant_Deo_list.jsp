                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Indent For Deo </h3>
                        </div>
                        ...
                        <s:form action="getSelfIndentDetailsDeoMger.action" id="approveInd" method="post"> 
					...
					<th>Plant Id</th>
					    ...
					    <td><s:property value="tblPlantMaster.plantId"/></td>  
                                            ...
                                            <td><s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==2 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}">Inventory Issue Pending</s:if>
                                                ...
                                                <s:if test="%{tblIndentStatusByIndentApprovedStatus.indentStatusId==1 && tblIndentStatusByIndentFinalStatus.indentStatusId==1 && tblIndentStatusByIndentProcurementStatus.indentStatusId==10}"><s:a href="javascript:void(0)" onclick="getSubmit1(%{indentId})" >Deo Order Pending   </s:a></s:if>
