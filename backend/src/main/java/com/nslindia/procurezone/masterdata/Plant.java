...
/**
 * Entity representing a plant in the system.
 * Maps to tbl_plant_master table.
 */
@Entity
@Table(name = "tbl_plant_master")
public class Plant {
    ...
    @Column(name = "plant_lmd", nullable = false)
    private LocalDate lastModifiedDate;

    @Column(name = "plant_lmu", nullable = false)
