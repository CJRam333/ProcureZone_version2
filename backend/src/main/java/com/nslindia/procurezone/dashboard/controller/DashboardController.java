...
public class DashboardController {
    ...
    @PreAuthorize("hasAnyRole('SUPERADMIN', 'ADMIN', 'PLANTMANAGER', 'USER', 'VIEWER', 'DEPTHEAD', 'PLANTMANAGER', 'STOREKEEPER', 'PROCUREMENT', 'EMPLOYEE', 'AUDITOR')")
    ...
    @PreAuthorize("hasAnyRole('SUPERADMIN', 'ADMIN', 'PLANTMANAGER', 'PROCUREMENT', 'VIEWER', 'DEPTHEAD', 'PLANTMANAGER', 'STOREKEEPER', 'EMPLOYEE', 'AUDITOR')")
    ...
    @PreAuthorize("hasAnyRole('SUPERADMIN', 'ADMIN', 'PLANTMANAGER', 'STOREKEEPER', 'VIEWER', 'DEPTHEAD', 'PLANTMANAGER', 'PROCUREMENT', 'EMPLOYEE', 'AUDITOR')")
    ...
    @PreAuthorize("hasAnyRole('SUPERADMIN', 'ADMIN', 'PLANTMANAGER', 'VIEWER', 'DEPTHEAD', 'PLANTMANAGER', 'STOREKEEPER', 'PROCUREMENT', 'EMPLOYEE', 'AUDITOR')")
